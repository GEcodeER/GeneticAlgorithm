...
public class MainFive {
    ...
    public static void main(String[] args) {
        ...
        //Setting the function too evaluate and find the maximum/minimum
        FunctionCoord.setFunction("f(x) = sin(x)*((x-2)^2) + 3");
        FunctionCoord.setInterval(new int[]{0, 10}); //Setting the interval in which to find the minimum or maximum
        GeneticAlgorithm<FunctionCoordRepository, FunctionCoord> geneticAlgorithmCoord = new GeneticAlgorithm<>();
